...
const matches = {
    ...
    '(\\[#=\\]CITEREF|\\[id=\'cite_ref|\\#cite_)': '#CITEREF* [[phab:TBC]]',
    ...
    '(div\.MainPageBG\.mp-box|\.main-wrapper|\.main-top|\.mp-|h2\.mp-h2|div\.mp-box|h1 \> \\[id\\=\'Welcome_to_Wikipedia)': 'Issue with main page (div.MainPageBG.mp-box) [[phab:T356344]]',
    ...
    '\\.(navbox-even|navbox|navbox-abovebelow|navbox-title)': 'navbox related issue [phab:TBC]',
